...
<html lang="en"> 
<head>
	<title>Oscars 2013 ballot</title>
	<meta charset="utf-8"> 
...
<?php
	...
	$sql = 'select * from oscars13_categories';
...
<body>
	...
	<p class="crit">In advance of the 85th annual Academy Awards on Sunday night, we asked readers to make their Oscar predictions in 12 major categories. You can see the real-time percentage of votes below. After the ceremony concludes on Feb. 24, we'll highlight each winner in gold. </p>
  ...
  <div id="container" class="container" style="margin:0px">
	...
	<div id="sourceCreds">
	Credits: Programming by Peggy Bustamante. Design by Nelson Hsu. Editorial content by John Hendrickson and Kelly Metz / DFM
	</div>
</div><!-- END container -->
